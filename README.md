...
> [!Note]
> 22.1 is not the latest version of Linux Mint. The latest one is 22.3 (at the time of writing), but it ships 
> with a kernel which has issues with VirtualBox. Consequently, I stick with 22.1.
